# =============================================================================
# 云途 AI 行程规划 - 数据模型 / Pydantic Schema 定义
# =============================================================================
# 定义所有 API 请求/响应的数据结构，包括：
#   - 行程生成请求/响应（TripRequest, Itinerary）
#   - 行程编辑请求（TripEditRequest）
#   - 行程保存/查询响应（TripDetailResponse, TripListResponse）
#   - Token 消耗统计（TokenUsage, TokenStatsResponse）
# =============================================================================
...
class UserRegisterRequest(BaseModel):
    ...
    email: str = Field(..., max_length=120, description="邮箱地址")
