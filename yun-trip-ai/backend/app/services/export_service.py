...
# 云途 AI 行程规划 - 行程导出服务
# =============================================================================
# 将已保存的 itinerary 导出为 Markdown 文本或 PDF 文件。
# Markdown 导出：纯文本拼接，适合分享和二次编辑。
# PDF 导出：使用 ReportLab 生成带排版、表格和页脚的正式文档。
# =============================================================================
...
def _draw_pdf_footer(canvas, doc, trip_detail: TripDetailResponse, font_name: str) -> None:
    ...
    canvas.drawString(doc.leftMargin, footer_y, f"云途 AI 行程规划 | {trip_detail.trip_id}")
