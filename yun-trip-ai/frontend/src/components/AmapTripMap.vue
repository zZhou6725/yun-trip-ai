...
function renderMarkers() {
  ...
  sorted.forEach((point) => {
    ...
    const imageHtml = point.imageUrl
      ...
      : `<div style="width:100%;height:100%;display:grid;place-items:center;border-radius:8px;background:linear-gradient(135deg,#dbeafe,#e0e7ff);color:#8b8fad;font-size:10px;">暂无图片</div>`;
